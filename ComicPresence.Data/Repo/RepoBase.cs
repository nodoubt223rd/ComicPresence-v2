...
using ComicPresence.Data.Connections;
using ComicPresence.Data.Interfaces;

namespace ComicPresence.Data.Repo
{
    public abstract class RepoBase<TEntity> : DataConnection, IRepoBase<TEntity> where TEntity : new()
    {
            #region Constructors
            ...
            protected RepoBase(IDbConnection connection, ISqlGenerator<TEntity> sqlGenerator)
                : base(connection)
            {
